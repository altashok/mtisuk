...
if(isset($_REQUEST["submit"]))
{
	...
	$to_mail_admin = "info@mtisuklimited.co.uk ";
	$bcc_mail = "mtisuklimited@gmail.com";

	$name=$_REQUEST['name'];
	$subject=$_REQUEST['subject'];
	$message=$_REQUEST['message'];
		
	$subject_admin = "MTIS UK | Enquiry Form Details";
	$mail_body_admin = "<html>
		...
		<tr>
			...
			<table align='center' border='0' cellpadding='0' cellspacing='0' style='width:70%; margin-top:60px; margin-bottom:60px;border:1px solid #dedede;'>
				<tbody>
					<tr>
						<td colspan='3' style='background-color:#d5d5d7; text-align:center; padding:10px 0%'><img alt='logo' src='https://globaltamilschool.co.uk/img/logo.png' style='height:90px;'/></td>
					</tr>
					<tr>
						...
						<table align='center' border='0' cellpadding='0' cellspacing='0' style='width:80%;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif; font-size: 13px;'>
							<tbody>
								<tr>
									<td colspan='3'>
									<p>&nbsp;Hi info@mtisuklimited.co.uk,</p>
									</td>
								</tr>
								<tr>
									<td>
								...
								<tr>
									<td>
										<table align='center' border='0' cellpadding='0' cellspacing='0' style='width:100%; border-collapse: collapse; border-color: #000;'>
											...
											<tr><td width='150' align='left' style='text-transform:capitalize;'>Subject:</td><td height='25' align='left'>  ".$subject."</td></tr>
